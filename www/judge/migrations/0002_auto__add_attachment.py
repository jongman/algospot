...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('judge_attachment', (
            ...
            ('path', self.gf('django.db.models.fields.TextField')(max_length=128)),
            ('md5', self.gf('django.db.models.fields.TextField')(max_length=32)),
    ...
    models = {
        ...
        'judge.attachment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'md5': ('django.db.models.fields.TextField', [], {'max_length': '32'}),
            'name': ('django.db.models.fields.TextField', [], {'max_length': '128'}),
            'path': ('django.db.models.fields.TextField', [], {'max_length': '128'}),
